...
function render(){
  ...
  $app.innerHTML=`
    ...
    <div class="cr-actions" style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;justify-content:center;margin:36px auto 0;max-width:600px;">
      <a href="${ROUTE.back}" style="flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;gap:7px;background:#fff;color:#1a1a1a;border:1px solid #1a1a1a;border-radius:14px;font-size:14px;font-weight:600;padding:15px 22px;text-decoration:none;transition:background .15s,color .15s;" onmouseover="this.style.background='#1a1a1a';this.style.color='#fff';" onmouseout="this.style.background='#fff';this.style.color='#1a1a1a';"><span style="font-size:16px;line-height:1;">&#8592;</span> 장바구니로 돌아가기</a>
      <button type="button" onclick="shareComparison(this)" style="flex:0 0 auto;width:108px;display:inline-flex;align-items:center;justify-content:center;gap:6px;background:#fff;color:#1a1a1a;border:1px solid #1a1a1a;border-radius:999px;font-size:13.5px;font-weight:600;padding:11px 0;cursor:pointer;font-family:inherit;transition:background .15s,color .15s;" onmouseover="this.style.background='#1a1a1a';this.style.color='#fff';" onmouseout="this.style.background='#fff';this.style.color='#1a1a1a';"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg>공유</button>
      <button type="button" onclick="saveComparison(this)" style="flex:0 0 auto;width:108px;display:inline-flex;align-items:center;justify-content:center;gap:6px;background:#fff;color:#1a1a1a;border:1px solid #1a1a1a;border-radius:999px;font-size:13.5px;font-weight:600;padding:11px 0;cursor:pointer;font-family:inherit;transition:background .15s,color .15s;" onmouseover="this.style.background='#1a1a1a';this.style.color='#fff';" onmouseout="this.style.background='#fff';this.style.color='#1a1a1a';"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>저장</button>
    </div>`;
