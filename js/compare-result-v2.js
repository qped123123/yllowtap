...
function render(){
  ...
  $app.innerHTML=`
    ...
    <div class="cr-actions" style="display:flex;flex-wrap:wrap;gap:10px;justify-content:center;margin:36px auto 0;max-width:600px;">
      <button type="button" onclick="saveComparison(this)" style="flex:1 1 0;display:inline-flex;align-items:center;justify-content:center;gap:7px;background:#fff;color:#1a1a1a;border:1px solid #1a1a1a;border-radius:14px;font-size:14px;font-weight:600;padding:15px 18px;cursor:pointer;font-family:inherit;transition:background .15s,color .15s;" onmouseover="this.style.background='#1a1a1a';this.style.color='#fff';" onmouseout="this.style.background='#fff';this.style.color='#1a1a1a';">저장하기</button>
      <button type="button" onclick="shareComparison(this)" style="flex:1 1 0;display:inline-flex;align-items:center;justify-content:center;gap:7px;background:#fff;color:#1a1a1a;border:1px solid #1a1a1a;border-radius:14px;font-size:14px;font-weight:600;padding:15px 18px;cursor:pointer;font-family:inherit;transition:background .15s,color .15s;" onmouseover="this.style.background='#1a1a1a';this.style.color='#fff';" onmouseout="this.style.background='#fff';this.style.color='#1a1a1a';">공유하기</button>
      <a href="${ROUTE.back}" style="flex:1 1 0;display:inline-flex;align-items:center;justify-content:center;gap:7px;background:#fff;color:#1a1a1a;border:1px solid #1a1a1a;border-radius:14px;font-size:14px;font-weight:600;padding:15px 18px;text-decoration:none;transition:background .15s,color .15s;" onmouseover="this.style.background='#1a1a1a';this.style.color='#fff';" onmouseout="this.style.background='#fff';this.style.color='#1a1a1a';"><span style="font-size:16px;line-height:1;">&#8592;</span> 장바구니로 돌아가기</a>
    </div>`;
